...
// Implementation of Lamport Clock for determining order of events for n processes
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                 ...
                 * 
                 * EVENT_NAME available for use right now:
                 *  - LOCAL
                 *  - SEND
                 * 
                 * For example:
                 * SEND 1 2 <Message> (process 1 sends a message to process 2)
