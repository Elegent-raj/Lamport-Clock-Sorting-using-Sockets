...
class SortServer {
	public static void main(String ar[]) throws Exception {
		ServerSocket ss = new ServerSocket(12345); // Object of ServerSocket instantiated and port number specified
		System.out.println("Server Started");
		Socket s = ss.accept(); // accpet method of ServerSocket
		...
		System.out.println("\nSorted list of numbers sent to client::");
